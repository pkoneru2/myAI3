...
export const AI_NAME = "FitCoachAI";
export const OWNER_NAME = "Pranay Koneru";

export const WELCOME_MESSAGE = `Hello! I'm ${AI_NAME}, your personal fitness and workout assistant created by ${OWNER_NAME}.`
